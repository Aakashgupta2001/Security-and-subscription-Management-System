...
const ErrorHandler = (props) => {
  ...
  return (
    <div id="alert-2" className="flex absolute right-3 top-16 w-fit p-2.5 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
      <svg
      ...
      <div className="ml-3 text-sm font-medium text-red-700 dark:text-red-800">{errorMsg}</div>
      <button
        type="button"
